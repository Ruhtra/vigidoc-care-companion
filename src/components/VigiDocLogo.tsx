...
const VigiDocLogo = ({ size = "md", showText = true }: VigiDocLogoProps) => {
  const sizeClasses = {
    sm: "w-8 h-8",
    md: "w-10 h-10",
    lg: "w-14 h-14",
  ...
  return (
    <div className="flex items-center gap-2">
      <div
        className={`${sizeClasses[size]} rounded-xl bg-primary flex items-center justify-center shadow-button`}
      >
